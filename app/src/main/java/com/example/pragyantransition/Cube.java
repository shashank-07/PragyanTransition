...
import static com.example.pragyantransition.OpenGLRenderer.xLimit;
...
class Cube {
    ...
    public float yTranslate = yLimit;
    public float xTranslate = 0.0f;
    public float velocity ;
    public float rateOfX;
    public float initialRateX;
    ...
    public void updateDrop() {
        ...
        if (yTranslate <= (-yLimit)) {

            stopCube();

        } else {
            velocity = velocity - rateofDrop;
